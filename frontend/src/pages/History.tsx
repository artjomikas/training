...
const History = () => {
  ...
  useEffect(() => {
    user &&
      workoutUsersService.getHistory().then((response) => {
        if (response) {
          ...
          <div className="flex flex-col gap-10">
            {workouts.length > 0 ? (
              workouts.map((res: any, i: number) => (
                ...
                >
                  <div className="text-slate-700 flex flex-col w-[35%] gap-5 place-content-center">
                    ...
                    <div className="flex flex-row gap-2  ">
                      <BiDumbbell size={20} />
                      <p>
                        {res.workoutWorkoutTypeName} /{" "}
                        {res.workoutSkillLevelName}
                      </p>
                    </div>
                  </div>
              ...
              <p>You must be logged in to see workout history</p>
            )}
          </div>
        </div>
